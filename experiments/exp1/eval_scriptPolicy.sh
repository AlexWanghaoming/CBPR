...
#    python evaluate_scriptPolicy.py --layout ${layout} --num_episodes 50 --mode intra --switch_human_freq 500 --seed ${seed} --algorithm BCP
...
#    python evaluate_scriptPolicy.py --layout ${layout} --num_episodes 50 --mode intra --switch_human_freq 500 --seed ${seed} --algorithm FCP
...
#    python evaluate_scriptPolicy.py --layout ${layout} --num_episodes 50 --mode inter --switch_human_freq 2 --seed ${seed} --algorithm FCP
    ...
    python okr_scriptedPolicy.py --layout ${layout} --num_episodes 50 --mode intra --switch_human_freq 500 --seed ${seed} --Q_len 5 --rho 0.1
...
#    python evaluate_scriptPolicy.py --layout ${layout} --num_episodes 50 --mode intra --switch_human_freq 500 --seed ${seed} --algorithm SP
