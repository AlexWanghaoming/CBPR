...
META_TASK_MODELS = {'cramped_room':[os.path.join(_curr_directory,'bc/BC_simple_(0.0, 0.0, 0.0, 0.0).pth'),
                    ...
                    'marshmallow_experiment': [
                        os.path.join(_curr_directory, 'bc/BC_marshmallow_experiment_vae_cluster0.pth'),
                        os.path.join(_curr_directory, 'bc/BC_marshmallow_experiment_vae_cluster1.pth'),
                        os.path.join(_curr_directory, 'bc/BC_marshmallow_experiment_vae_cluster2.pth'),
                        os.path.join(_curr_directory, 'bc/BC_marshmallow_experiment_vae_cluster3.pth'),
                        ],
                    }
