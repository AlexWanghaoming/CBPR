...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--data-infile", type=str, default='../static/human_data/cleaned/2020_hh_trials_all.pickle')
    parser.add_argument("-o", "--data-outdir", type=str, default='../static/human_data/cleaned/2020_hh_trials_all.out')
