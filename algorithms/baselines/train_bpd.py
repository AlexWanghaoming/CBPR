...
_log = Logger(name='sss')
# run: Literal["ppo", "bpd", "distill", "gail"] = "ppo"
run: Literal["ppo", "bpd", "distill", "gail"] = "bpd"
...
latent_size = 1000  # For use with OvercookedPPODistributionModel
...
ppo_observation_space = env.observation_space
